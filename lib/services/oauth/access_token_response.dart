...
Credentials accessTokenResponse(
    http.Response response, Uri tokenEndpoint,
    DateTime startTime, List<String> scopes, String delimiter, {
        required Map<String, dynamic> Function(MediaType contentType, String body) getParameters
      }
    ) {
  ...
  try {
    ...
    return Credentials(parameters['access_token'],
        ...
        scopes: scopes,
        expiration: expiration!, delimiter: '', getParameters: (MediaType mediaType, String body) { return <String, dynamic>{}; });
